...
- un objectif unique et compréhensible ;
- un niveau accessible avec une petite difficulté supplémentaire ;
- un retour immédiat et bienveillant ;
- une répétition espacée sur plusieurs séances courtes.
...
Pour rendre ces entraînements plus ludiques, consultez nos [jeux pour enfants dyslexiques](/jeux-dyslexie).
...
- Utiliser des supports trop difficiles ou trop enfantins.
- Introduire plusieurs nouvelles correspondances à la fois.
- Corriger chaque erreur avant que l’enfant ait cherché.
- Faire recopier ou relire une longue liste après un échec.
- Chronométrer lorsque la vitesse crée de l’anxiété.
- Prolonger la séance pour terminer une fiche.
- Comparer les performances à celles d’un autre enfant.
- Remplacer les objectifs de l’orthophoniste par une méthode en ligne.
...
- Travaillez une compétence à la fois.
- Commencez par les sons et les syllabes déjà accessibles.
- Utilisez des séances courtes et régulières.
- Alternez entraînement ciblé et lecture porteuse de sens.
- Donnez des aides précises plutôt que des injonctions générales.
- Arrêtez avant l’épuisement et valorisez les stratégies.
- Coordonnez les activités avec les professionnels.
...
Découvrez les exercices progressifs disponibles dans **Au-delà des Dys** pour compléter les entraînements réalisés à la maison.

**CTA principal :** Découvrir les exercices Au-delà des Dys

---

## Liens internes à intégrer

- [Comment aider un enfant dyslexique](/aider-enfant-dyslexique)
- [Jeux pour aider un enfant dyslexique](/jeux-dyslexie)
- [Outils numériques pour les enfants Dys](/outils-dyslexie)
- [Livres adaptés aux enfants dyslexiques](/livres-dyslexie)

## Liens externes recommandés

- [Assurance Maladie — Accompagnement familial de la dyslexie](https://www.ameli.fr/assure/sante/themes/troubles-langage-ecrit/accompagnement-familial-scolarisation)
- [Assurance Maladie — Suivi médical et rééducation](https://www.ameli.fr/assure/sante/themes/troubles-langage-ecrit/prise-charge-medicale-reeducation)
- [Haute Autorité de Santé — Parcours de santé relatif aux troubles Dys](https://www.has-sante.fr/jcms/pprd_2974221/fr/troubles-dys-vers-un-parcours-de-sante-gradue-et-coordonne)

## Textes ALT recommandés pour les images

1. **Image principale :** `Enfant dyslexique réalisant un exercice de lecture avec un adulte`
2. **Phonologie :** `Jetons utilisés pour fusionner les sons d’un mot`
3. **Syllabes :** `Cartes-syllabes assemblées pour former un mot`
4. **Lecture :** `Court texte aéré utilisé pour entraîner la fluidité`
5. **Organisation :** `Séance de lecture courte organisée en étapes progressives`

## Données structurées recommandées

- `Article` ou `BlogPosting`
- `FAQPage` pour les cinq questions visibles
- `BreadcrumbList`
- `HowTo` uniquement si les étapes balisées sont toutes visibles et directement réalisables
- `Organization` pour Au-delà des Dys

Renseigner `headline`, `description`, `image`, `author`, `publisher`, `datePublished`, `dateModified` et `mainEntityOfPage`. Le balisage `FAQPage` doit correspondre exactement au contenu publié.
