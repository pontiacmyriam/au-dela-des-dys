...
1. regarder le travail demandé ;
2. choisir l’ordre des tâches ;
3. préparer le matériel ;
4. travailler pendant une durée définie ;
5. vérifier l’essentiel et ranger.
...
Si la confiance est déjà fragilisée, consultez aussi notre article sur la [dyslexie et l’estime de soi](/dyslexie-confiance-en-soi).
...
Lorsque les conflits sont fréquents, notez leur contexte et sollicitez l’école. Ils peuvent signaler que la charge ou les adaptations ne correspondent plus aux besoins. Retrouvez nos conseils pour mieux collaborer autour de la [dyslexie à l’école](/dyslexie-ecole).
...
## Prolongez les apprentissages dans un cadre motivant

Découvrez les activités proposées dans **Au-delà des Dys** pour prolonger les apprentissages à la maison dans un cadre progressif.

**CTA principal :** Découvrir les activités Au-delà des Dys
...
- [Dyslexie et confiance en soi](/dyslexie-confiance-en-soi)
- [Dyslexie et école](/dyslexie-ecole)
- [Outils numériques pour les enfants Dys](/outils-dyslexie)
- [Aménagements scolaires](/amenagement-scolaire-dys)

## Liens externes recommandés

- [Assurance Maladie — Accompagnement familial et scolarisation](https://www.ameli.fr/assure/sante/themes/troubles-langage-ecrit/accompagnement-familial-scolarisation)
...
- [Éducation nationale — Réseaux d’aides spécialisées aux élèves en difficulté](https://www.education.gouv.fr/les-reseaux-d-aides-specialisees-aux-eleves-en-difficulte-rased-11312)

## Textes ALT recommandés pour les images

1. **Image principale :** `Parent accompagnant sereinement les devoirs d’un enfant Dys`
2. **Organisation :** `Checklist visuelle pour organiser une séance de devoirs`
3. **Fractionnement :** `Travail scolaire divisé en courtes étapes avec des pauses`
4. **Autonomie :** `Enfant préparant seul son matériel scolaire`
5. **Dialogue :** `Parent et enseignant échangeant sur les adaptations des devoirs`
...
- `BreadcrumbList`
- `HowTo` uniquement si une procédure complète et visible est balisée
- `Organization` pour Au-delà des Dys

Renseigner `headline`, `description`, `image`, `author`, `publisher`, `datePublished`, `dateModified` et `mainEntityOfPage`. Le balisage `FAQPage` doit reprendre exactement les questions et réponses affichées.
